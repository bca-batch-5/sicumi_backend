...
public class UserServicesImpl implements UserServices {
  ...
  public ResponseData<Object> findEmail(EmailRequest email) throws CustomNullException {
    ...
    String localLink = "Click this link : http://localhost:3000/Reset/Confirm/" + encodedString
        + " to continue and reset your password";
  ...
  @Override
  public ResponseData<Object> checkPin(CheckPinRequest checkPinRequest, Integer userId) {
    ...
    if (!user.getPin().equals(pin)) {
      responseData = new ResponseData<Object>(HttpStatus.BAD_REQUEST.value(), "pin yang anda masukkan salah", null);
      return responseData;
    } else {
      responseData = new ResponseData<Object>(HttpStatus.OK.value(), "Pin yang anda masukkan benar", user);
    return responseData;
    }
